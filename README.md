...
On the wazobia-frontend, on the top-right, click settings
Input the url from the server and save

Voila
Star the repo if you like it so that i'll come back to complete it soon
